...
public class ProxyingHandlerMethodArgumentResolver extends ModelAttributeMethodProcessor
	...
	static class ProjectedPayloadDeprecationLogger {
		...
		private static final String MESSAGE = "Parameter %sat index %s in [%s] is not annotated with @ProjectedPayload. Parameters not annotated with @ProjectedPayload (at the parameter or type level) is not supported.";
